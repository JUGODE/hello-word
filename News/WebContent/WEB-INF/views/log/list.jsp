...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            ...
            <a href="#" id="search-btn" class="easyui-linkbutton" iconCls="icon-search">搜索</a><!-- iconCls="icon-search"剪切来的无法识别的属性 -->
        </div>
    </div>
    <!-- End of toolbar -->
    <table id="data-datagrid" class="easyui-datagrid" toolbar="#wu-toolbar"></table><!-- toolbar="#wu-toolbar"剪切来的无法识别的属性 -->
</div>
