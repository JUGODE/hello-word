	...
	<div class="tab-content">
	  <div role="tabpanel" class="tab-pane contact active" id="notice">
		...
		<div role="tabpanel" class="tab-pane contact" id="contact">
		  <h2>QQ:
			  <a href="#" target="_blank" rel="nofollow" data-toggle="tooltip" data-placement="bottom" title=""  data-original-title="QQ:2573644906">2573644906</a>
		  </h2>
		  <h2>Email:
		  <a href="#" target="_blank" data-toggle="tooltip" rel="nofollow" data-placement="bottom" title=""  data-original-title="#">晴川@163.com</a></h2>
	  </div>
	</div>
  </div>
...
<div class="widget widget_hot">
 ...
 <div class="widget widget_sentence">    
	<a href="http://www.qcuwh.cn/" target="_blank" rel="nofollow" title="cms" >
	<img style="width: 100%" src="../resources/home/images/ad1.png" alt="cms" ></a>    
 </div>
 <div class="widget widget_sentence">    
	<a href="http://www.qcuwh.cn/" target="_blank" rel="nofollow" title="cms" >
	<img style="width: 100%" src="../resources/home/images/ad2.png" alt="cms" ></a>    
 </div>
<div class="widget widget_sentence">
  <h3>友情链接</h3>
  <div class="widget-sentence-link">
	<a href="https://www.baidu.com/" title="百度" target="_blank" >百度</a>&nbsp;&nbsp;&nbsp;
	<a href="http://www.qcuwh.cn/" title="晴川学院" target="_blank" >晴川学院</a>&nbsp;&nbsp;&nbsp;
  </div>
</div>
</aside>
<script>
		...
		success:function(data){
			if(data.type == 'success'){
				...
				for(var i=0;i<newsList.length;i++){
					...
					li += '<img class="thumb" data-original="../resources/home/images/201610401139.jpg" src="'+newsList[i].photo+'" alt="'+newsList[i].id+'"  style="display: block;">';
