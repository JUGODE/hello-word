...
<div class="container">
  <div class="header-topbar hidden-xs link-border">
	<ul class="site-nav topmenu">
	  ...
	  <li><a href="#" >标签云</a></li>
		...
		-->
		<li><a href="#" onclick="addFavorite('http://www.qcuwh.cn/','cms')" title="RSS订阅" >
			<i class="fa fa-rss">
			</i> RSS订阅
		</a></li>
	</ul>
			光明消退，黑暗降临，面对灾难，宜坚贞守持！</div>
  <div class="navbar-header">
	<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#header-navbar" aria-expanded="false"> <span class="sr-only"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
	<h1 class="logo hvr-bounce-in"><a href="/News/index/index" title="基于Java的cms网站"><img src="../resources/home/images/logo.png" alt="cms系统"></a></h1>
  </div>
  <div class="collapse navbar-collapse" id="header-navbar">
	...
	<ul class="nav navbar-nav navbar-right">
	  <li><a data-cont="cms" title="基于Java的cms网站" href="/News/index/index">首页</a></li>
